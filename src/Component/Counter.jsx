...
function Counter(){
    ...
    const dispatch =useDispatch()
        //component can access the state using useselecter hook
    ...
    <>
        <div className="d-flex align-items-center justify-content-center w-100 mt-5 flex-column "> 
            ...
            <div className="w-100 mt-5">
                <input type="text" onChange={(e)=>setRange(e.target.value)} className="form-control"placeholder="enter thee range" style={{borderColor:'blue'}} />
            </div>
